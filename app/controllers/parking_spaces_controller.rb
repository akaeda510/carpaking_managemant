...
た"
  ...
  def parking_space_params
    params.require(:parking_space).permit(:name, :price, :width, :length, :description, :status, :parking_type, garage_detail_attributes: [ :id, :height, :_destroy ], parking_space_option_ids: [])
  end
